...
st.header("You are hired in a consultancy firm. One of their clients wants to open a remote kitchen (only delivery) in Bangalore. Suggest them which location will be suitable for their restaurant and what should be the price of different types of dishes in the early days.")

filepath = r"C:\Users\karan\Downloads\Compressed\Data _Scrapping_Project-20230627T163344Z-001\Data _Scrapping_Project\Zomato_Project\data.json"

def load_lottiefile(filepath: str):
    with open(filepath, "r") as f:
        return json.load(f)

lottielink = load_lottiefile(filepath)
